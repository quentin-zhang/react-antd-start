(function() {
    var h = {}
      , mt = {}
      , c = {
        id: "7bf21b2f950d8714770443177726539e",
        dm: ["ecloud.inspur.com/tenant-portal/cloud-erp/index.html"],
    ...
    mt.cookie.set = function(b, a, e) {
        var d;
        e.V && (d = new Date,
        d.setTime(d.getTime() + e.V));
        document.cookie = b + "=" + a + (e.domain ? "; domain=" + e.domain : "") + (e.path ? "; path=" + e.path : "") + (d ? "; expires=" + d.toGMTString() : "") + (e.Ib ? "; secure" : "")
    }
    ;
    ...
    (function() {
        ...
        mt.e.Z = function(a, b) {
            ...
            for (; a.parentNode != t; ) {
                ...
                if ((p = "" !== a.id) && b) {
                    ...
                    k.push(p)),
                    d.unshift(encodeURIComponent(String(a.nodeName).toLowerCase()) + (1 < l ? "[" + n + "]" : ""));
                a = a.parentNode
            }
            k.push(d.join(">"));
            return k
        ...
        mt.e.getAttribute = function(a, b) {
            ...
            if (!d && a.attributes && a.attributes.length)
                for (var k = a.attributes, l = k.length, n = 0; n < l; n++)
                    k[n].nodeName === b && (d = k[n].nodeValue);
            return d
        }
        ;
        mt.e.J = function(a) {
    ...
    mt.localStorage.set = function(b, a, e) {
        ...
        try {
            ...
            window.localStorage.setItem(b, a)) : mt.localStorage.P() && (mt.localStorage.h.expires = d.toUTCString(),
    ...
    ;
    mt.ha.Ab = function(b, a, e, d, k) {
        return '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" id="' + b + '" width="' + e + '" height="' + d + '"><param name="movie" value="' + a + '" /><param name="flashvars" value="' + (k || "") + '" /><param name="allowscriptaccess" value="always" /><embed type="application/x-shockwave-flash" name="' + b + '" width="' + e + '" height="' + d + '" src="' + a + '" flashvars="' + (k || "") + '" allowscriptaccess="always" /></object>'
    }
    ;
    mt.url = {};
    ...
    (function() {
        function b() {
            for (var a = u, b = document.getElementsByTagName("script"), d = b.length, d = 100 < d ? 100 : d, k = 0; k < d; k++) {
                var l = b[k].src;
    ...
    h.l = {
        ...
        ca: x() || "https:" === document.location.protocol ? "https:" : "http:",
        Gb: 0,
        yb: 6E5,
        fb: 6E5,
        Hb: 5E3,
    ...
    (function() {
        var b = {
            ...
            I: function(a, b) {
                this.r[a] = this.r[a] || [];
                for (var d = this.r[a].length, k = 0; k < d; k++)
                    this.r[a][k](b)
            }
        };
        return h.A = b
    ...
    (function() {
        function b(b, d) {
            ...
            k.charset = "utf-8";
            a.d(d, "Function") && (k.readyState ? k.onreadystatechange = function() {
                if ("loaded" === k.readyState || "complete" === k.readyState)
                    k.onreadystatechange = t,
                    d()
            }
            : k.onload = function() {
                d()
        ...
        var b = mt.lang
          ...
          , f = {
            oa: function() {
                return function(g) {
                    if (h.b && h.b.D && c.aet && c.aet.length) {
                        ...
                        if (d) {
                            var m = h.b.na
                              , q = a.getAttribute(d, k.ma) != t ? s : u;
                            if (a.getAttribute(d, k.la) == t)
                                if (q)
                                    f.Q(f.X(d, g));
                                else {
                                    var e = a.J(d);
                                    if (b.C(m, "*") || b.C(m, e))
                                        ...
                                        for (; d.parentNode != t; ) {
                                            var q = d.parentNode
                                              , e = a.J(q)
                                              , v = "a" === e && b.C(m, "a") ? s : u
                                              , e = "button" === e && b.C(m, "button") ? s : u
                                              , z = a.getAttribute(q, k.ma) != t ? s : u;
                                            if (a.getAttribute(q, k.la) == t && (v || e || z)) {
                                                f.Q(f.X(q, g));
                                                break
                                            }
                                            d = d.parentNode
            ...
            X: function(g, e) {
                var m = {}
                  , q = k.Ea;
                m.id = a.getAttribute(g, q.id) || a.getAttribute(g, "id") || "";
                m.S = a.getAttribute(g, q.S) || a.getAttribute(g, "class") || "";
                m.ka = a.getAttribute(g, q.ka) || a.Ta(g);
                m.content = a.getAttribute(g, q.content) || a.Pa(g);
                m.O = a.getAttribute(g, q.O) || a.J(g);
                m.link = a.getAttribute(g, q.link) || a.getAttribute(g, "href") || "";
                m.type = e.type || "click";
                q = b.ta(g.offsetTop) ? g.offsetTop : 0;
                "click" === e.type ? q = d.sa ? e.clientY + Math.max(document.documentElement.scrollTop, document.body.scrollTop) : e.pageY : "touchend" === e.type && (e.ea && b.d(e.ea.changedTouches, "Array") && e.ea.changedTouches.length) && (q = e.ea.changedTouches[0].pageY);
                m.qb = q;
                return m
            },
            Q: function(g) {
                var a = b.j
                  , a = [+new Date - (h.b.s !== r ? h.b.s : n), a(g.id), a(g.S), a(g.O), a(g.ka), a(g.link), a(g.content), g.type, g.qb].join("*");
                f.R(a);
                b.C(["a"], g.O) && b.d(this.G(), "Function") && this.G()()
            },
            R: function(a) {
                a.length > k.T || (encodeURIComponent(p.join("!") + a).length > k.T && (f.H(p.join("!")),
                p = []),
                p.push(a))
            },
            H: function(a) {
            ...
            G: function() {
                return function() {
                    p && p.length && (f.H(p.join("!")),
                    p = [])
                }
            }
        };
        b.aa() && "" !== c.aet && l.c("pv-b", function() {
            e.c(document, "click", f.oa());
            "ontouchend"in document && e.c(window, "touchend", f.oa());
    ...
    (function() {
        var b = mt.event
          ...
          , p = {
            Ia: function() {
                return function() {
                    h.b && (h.b.D && c.aet && c.aet.length) && (window.clearTimeout(n),
            ...
            Aa: function(a) {
                p.R([+new Date - (h.b.s !== r ? h.b.s : k), a].join("*"))
            },
            R: function(a) {
                if (encodeURIComponent(l.join("!") + a).length > e.T || 5 < l.length)
                    p.H(l.join("!")),
                    l = [];
                l.push(a)
            },
    ...
    (function() {
        ...
        function e(a) {
            ...
            if (a in g)
                ...
                for (var m = ["webkit", "ms", "moz", "o"], q = 0; q < m.length; q++) {
                    var e = m[q] + a.charAt(0).toUpperCase() + a.slice(1);
                    if (e in g) {
                        b = e;
                        break
                    }
        ...
        function d(b) {
            if (!("focus" == b.type || "blur" == b.type) || !(b.target && b.target != window))
                g = "focus" == b.type || "focusin" == b.type ? s : u,
                a()
        }
        var k = mt.event, l = h.A, n = s, p = s, f = s, g = s, w = +new Date, m = w, q = 0, y = s, v = e("visibilityState"), z = e("hidden"), C;
        a();
        (function() {
            var g = v.replace(/[vV]isibilityState/, "visibilitychange");
            k.c(document, g, a);
            k.c(window, "pageshow", a);
            k.c(window, "pagehide", a);
            "object" == typeof document.onfocusin ? (k.c(document, "focusin", d),
            k.c(document, "focusout", d)) : (k.c(window, "focus", d),
            k.c(window, "blur", d))
        }
        )();
        h.U = {
        ...
        function b(a, b, m, q) {
            if (!(a === r || b === r || q === r)) {
                if ("" === a)
                    return [b, m, q].join("*");
                a = String(a).split("!");
                for (var e, d = u, f = 0; f < a.length; f++)
                    if (e = a[f].split("*"),
                    String(b) === e[0]) {
                        e[1] = m;
                        e[2] = q;
        ...
        function a(g) {
            for (var b in g)
                if ({}.hasOwnProperty.call(g, b)) {
                    var m = g[b];
                    e.d(m, "Object") || e.d(m, "Array") ? a(m) : g[b] = String(m)
                }
        }
        var e = mt.lang
          , d = mt.m
          ...
          , f = {
            ...
            init: function() {
                ...
                n.c("stag-b", function() {
                    h.b.a.api = f.f || f.N ? f.f + "_" + f.N : "";
                    h.b.a.ct = [decodeURIComponent(h.b.getData("Hm_ct_" + c.id) || ""), f.p.ia, f.p.page].join("!")
                });
                n.c("stag-d", function() {
                    h.b.a.api = 0;
                    f.f = 0;
                    ...
                    window._hmt = {
                        ...
                        push: function() {
                            for (var a = window._hmt, b = 0; b < arguments.length; b++) {
                                var g = arguments[b];
                                e.d(g, "Array") && (a.cmd[a.id].push(g),
                                "_setAccount" === g[0] && (1 < g.length && /^[0-9a-f]{32}$/.test(g[1])) && (g = g[1],
                                a.id = g,
                                a.cmd[g] = a.cmd[g] || []))
                            }
                        }
            ...
            Ka: function() {
                ...
                if (a && a.cmd && a.cmd[c.id])
                    for (var b = a.cmd[c.id], m = /^_track(Event|MobConv|Order|RTEvent)$/, e = 0, d = b.length; e < d; e++) {
                        var v = b[e];
                        m.test(v[0]) ? f.F.push(v) : f.fa(v)
                    }
                a.cmd[c.id] = {
                    push: f.fa
                }
            ...
            _setCustomVar: function(a) {
                if (!(4 > a.length)) {
                    ...
                    if (0 < b && 6 > b && 0 < m && 4 > m) {
                        f.N++;
                        for (var d = (h.b.a.cv || "*").split("!"), k = d.length; k < b - 1; k++)
                            d.push("*");
                        d[b - 1] = m + "*" + e.j(a[2]) + "*" + e.j(a[3]);
                        h.b.a.cv = d.join("!");
                        a = h.b.a.cv.replace(/[^1](\*[^!]*){2}/g, "*").replace(/((^|!)\*)+$/g, "");
                        "" !== a ? h.b.setData("Hm_cv_" + c.id, encodeURIComponent(a), c.age) : h.b.hb("Hm_cv_" + c.id)
                    }
                }
            },
    ...
    (function() {
        function b() {
            ...
            this.ra = this.qa = s,
            this.D = g.D,
            this.na = k.aa() && 0 < c.aet.length ? c.aet.split(",") : "",
            this.$ = u,
            this.init())
        }
        var a = mt.url
        ...
        b.prototype = {
            ...
            nb: function() {
                var a, b, d, e, f;
                g.w = this.getData("Hm_lpvt_" + c.id) || 0;
                13 === g.w.length && (g.w = Math.round(g.w / 1E3));
                b = this.Ua();
                a = 4 !== b ? 1 : 0;
                ...
                this.setData("Hm_lpvt_" + c.id, g.o);
            ...
            mb: function() {
                for (var a = [], b = this.a.et, d = +new Date, e = 0, f = g.ya.length; e < f; e++) {
                    var k = g.ya[e]
                      , l = this.a[k];
            ...
            ob: function() {
                ...
                this.a.cm = a.k(b, g.$a) || "";
                this.a.cp = a.k(b, g.ab) || a.k(b, g.ub) || "";
                this.a.cw = a.k(b, g.Za) || a.k(b, g.wb) || "";
                this.a.ci = a.k(b, g.Xa) || a.k(b, g.tb) || "";
                this.a.cf = a.k(b, g.bb) || a.k(b, g.vb) || "";
                this.a.cu = a.k(b, g.Ya) || a.k(b, g.rb) || ""
            },
            init: function() {
                try {
                    this.ob(),
                    0 === this.a.nv ? this.lb() : this.ga(".*"),
                    h.b = this,
                    this.Fa(),
                    w.I("pv-b"),
                    this.jb()
            ...
            i: function(a) {
                if (this.ra) {
                    var b = this;
                    b.a.rnd = Math.round(Math.random() * g.da);
                    w.I("stag-b");
                    var d = g.ca + "//" + g.wa + "?" + b.mb();
                    w.I("stag-d");
                    b.Ba(d);
                    e.log(d, function(d) {
                        b.ga(d);
            ...
            Fa: function() {
                var b = document.location.hash.substring(1)
                  , d = RegExp(c.id)
                  , e = a.Y(document.referrer) === g.Ca ? 1 : 0
                  , f = a.k(b, "jn")
                  , k = /^heatlink$|^select$|^pageclick$/.test(f);
                b && (d.test(b) && e && k) && (this.a.rnd = Math.round(Math.random() * g.da),
                b = document.createElement("script"),
                b.setAttribute("type", "text/javascript"),
                b.setAttribute("charset", "utf-8"),
                b.setAttribute("src", g.protocol + "//" + c.js + f + ".js?" + this.a.rnd),
            ...
            ga: function(a) {
                ...
                (b = b.replace(a, "").replace(/,$/, "")) ? f.set("Hm_unsent_" + c.id, b) : f.remove("Hm_unsent_" + c.id))
            },
            lb: function() {
                var a = this
                ...
                if (b)
                    for (var b = b.split(","), d = function(b) {
                        e.log(g.ca + "//" + decodeURIComponent(b), function(b) {
                            a.ga(b)
                        })
    ...
    var I = h.load
      , J = h.l.protocol;
    if (c.qiao) {
        for (var K = [J + "//goutong.baidu.com/site/"], L = c.id, M = 5381, N = L.length, O = 0; O < N; O++)
            M = (33 * M + Number(L.charCodeAt(O))) % 4294967296;
        ...
        if ("undefined" !== typeof h.b && (c.med || (!b.sa || 7 < b.cb) && c.cvcc)) {
            var k, l, n, p, f = function(a) {
                ...
                if (e) {
                    ...
                    f.snv = g) : a.d(l, "String") && n.test(l) && (f.sn = "wrap",
                    f.snv = l);
                    f.id = m
                }
                h.b.a.et = 86;
                ...
                p = {
                    click: function() {
                        for (var a = [], b = f(document.getElementsByTagName("a")), b = [].concat.apply(b, f(document.getElementsByTagName("area"))), b = [].concat.apply(b, f(document.getElementsByTagName("img"))), d, e, g, k = 0, l = b.length; k < l; k++)
                            ...
                            (n.test(e) || n.test(g) || m.test(d)) && a.push(b[k])) : (n.test(e) || n.test(g)) && a.push(b[k])) : m !== r && (d = d.getAttribute("id"),
                            m.test(d) && a.push(b[k]));
                        return a
                    }
                }
            ...
            var k = {
                za: function() {
                    for (var a = c.cvcf.length, d, p = 0; p < a; p++)
                        (d = b.Na(decodeURIComponent(c.cvcf[p]))) && e.c(d, "click", k.Ja())
                },
                Ja: function() {
                    return function() {
                        h.b.a.et = 86;
